...
REM https://stackoverflow.com/questions/31506158/running-openssl-from-a-bash-script-on-windows-subject-does-not-start-with
...
openssl req -passin pass:1111 -new -key client.key -out client.csr -subj  "//C=SE\ST=GT\L=Cupertino\O=YourCompany\OU=YourApp\CN=%CLIENT-COMPUTERNAME%"
